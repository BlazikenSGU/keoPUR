    ...
    <main class="main">
        <section class="home" id="home">
            <div class="home__container container grid">
                <img src="assets/img/home.png" class="home__img" alt="">
                ...
                <div class="home__data">
                    ...
                    <p class="home__description">
                        ...
                        thường được liên kết với nhau bằng urethane (carbamate, một hợp chất hữu cơ có nguồn gốc từ axit
                        carbamic).
                    </p>
                    <a href="#about" class="button button--flex">
                        Xem thêm <i class="ri-arrow-right-down-line"></i>
                    </a>
                </div>
                ...
                <div class="home__social">
                    ...
                    <div class="home__social-links">
                        ...
                        <a href="https://www.youtube.com/" target="_blank" class="home__social-link">
        ...
        <section class="product section container" id="products">
            <h2 class="section__title-center">
                Một số dòng <br> sản phảm nổi bật
            </h2>
            ...
            <div class="product__container grid">
                <article class="product__card">
                    ...
                    <img src="assets/img/product1.png" class="product__img" alt="">

                    <h3 class="product__title">Keo hotmelt PUR</h3>
                    <span class="product__price">599.000vnd</span>
                ...
                <article class="product__card">
                    ...
                    <img src="assets/img/product2.png" class="product__img" alt="">

                    <h3 class="product__title">AKFIX PA370 | KEO DÁN GỖ PUR</h3>
                    <span class="product__price">132.000vnd</span>
                ...
                <article class="product__card">
                    ...
                    <img src="assets/img/product3.png" class="product__img" alt="">

                    <h3 class="product__title">Jowatherm-Reaktant 604.40</h3>
                    <span class="product__price">399.000vnd</span>
                ...
                <article class="product__card">
                    ...
                    <img src="assets/img/product4.png" class="product__img" alt="">

                    <h3 class="product__title">Keo hạt PVC Jowat</h3>
                    <span class="product__price">599.000vnd</span>
                ...
                <article class="product__card">
                    ...
                    <img src="assets/img/product5.png" class="product__img" alt="">

                    <h3 class="product__title">Keo PUR dánh cạnh viền</h3>
                    <span class="product__price">399.000vnd</span>
                ...
                <article class="product__card">
                    ...
                    <img src="assets/img/product6.png" class="product__img" alt="">

                    <h3 class="product__title">PUR Hotmelt Jowat 609.50</h3>
                    <span class="product__price">999.000vnd</span>
                ...
                <form action="" class="contact__form">
                    <div class="contact__inputs">
                        ...
                        <div class="contact__content contact__area">
                            <textarea name="message" placeholder=" " class="contact__input" id="" cols="30"
                                rows="5"></textarea>
